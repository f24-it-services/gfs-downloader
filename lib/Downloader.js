    ...
    value: function __downloadFields(generatedDate) {
      ...
      var _loop = function _loop(fc) {
        _this2.fields.forEach(function (field) {
          ...
          var writeStream = _fs2.default.createWriteStream(localPath);
          var forecastOffset = fc;

          downloads.push(function () {
            return _this2.client.downloadField(generatedDate, forecastOffset, field, writeStream).then(function (result) {
